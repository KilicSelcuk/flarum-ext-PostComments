...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('kilicselcuk/flarum-ext-postcomments', function () {
  console.log('[kilicselcuk/flarum-ext-postcomments] Hello, admin!');
});
